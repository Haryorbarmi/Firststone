...
import {
  IconArrowUpRight, IconArrowRight, IconPlay,
  IconBinoculars, IconPencilRuler, IconBuilding2, IconHandshake,
  IconMail, IconPhone, IconPin,
    ...
    <section className="hero" id="top">
      ...
      <div className="container">
        <div className="inner reveal" style={{ textAlign: 'left' }}>
          <h1 style={{ textAlign: 'left', fontWeight: '500', fontSize: '66px' }}>
            Building Excellence<br />Since Day One
          </h1>
          <p className="sub" style={{ fontSize: '18px' }}>
            Premium construction services for residential and commercial projects across Nigeria. From foundation to finish, we deliver on time, on budget, and beyond expectations.
          </p>
          <div className="ctas" style={{ alignItems: 'center', textAlign: 'left', justifyContent: 'flex-start' }}>
            <a href="#contact" className="btn brand" style={{ backgroundColor: 'rgb(255, 255, 255)', color: 'rgb(19, 19, 19)', opacity: '0.7' }}>
              Start Your Project <IconArrowUpRight size={14} />
            </a>
    ...
    <section className="about" id="about">
      <div className="container">
        <p className="big-statement scroll-reveal-text" ref={wrapRef}>
          {words.map((w, i) => (
            <span key={i}>
              <span className="sr-word" ref={el => wordRefs.current[i] = el}>{w}</span>
              {i < words.length - 1 ? ' ' : ''}
            </span>
          ))}
        </p>
        <div className="actions reveal">
          <Link to={{ pathname: '/', hash: '#process' }} className="btn ghost">
            Learn Our Story <IconArrowUpRight size={12} />
          </Link>
        </div>
      </div>
    </section>
...
function Projects() {
  const projects = [
    { tag: 'Hospitality', title: 'Lakeside Resort & Spa', loc: 'Victoria Island, Lagos', img: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=900&q=80' },
    { tag: 'Commercial / Tech', title: 'Vertex Tech Park', loc: 'Lekki, Lagos', img: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?auto=format&fit=crop&w=900&q=80' },
    { tag: 'Student Housing', title: 'Urban Nest Student Living', loc: 'Ibadan, Oyo', img: 'https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=900&q=80' },
    { tag: 'Residential', title: 'Grand Horizon Hotel & Suites', loc: 'Abuja', img: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=900&q=80' },
    { tag: 'Mixed-Use', title: 'Harbour Point Towers', loc: 'Port Harcourt, Rivers', img: 'https://images.unsplash.com/photo-1577415124269-fc1140a69e91?auto=format&fit=crop&w=900&q=80' },
    { tag: 'Healthcare', title: 'Northbridge Medical Centre', loc: 'Kano', img: 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&w=1200&q=80' },
  ];
        ...
        <div className="big-test reveal" style={{ backgroundImage: `url(${IMG})` }}>
          ...
          <div className="content">
            <div className="avatars">
              ...
              <div className="av brand" style={{ backgroundColor: 'rgb(46, 103, 75)' }}><BrandMark size={22} color="#FFFFFF" /></div>
            </div>
            <div className="quote">
          ...
          <div className="bottom-actions">
            ...
            <Link className="btn white" to="/contact" style={{ backgroundColor: 'rgba(255, 250, 249, 0.85)' }}>
              Get Started <IconArrowUpRight size={12} />
            </Link>
          </div>
        </div>
      </div>
...
function Services() {
  const items = [
    { title: 'Property Development', desc: 'End-to-end delivery of large-scale residential and mixed-use developments, from land acquisition through to final handover.', tags: ['Land Acquisition', 'Feasibility Studies', 'Masterplanning', 'Residential Builds'], img: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?auto=format&fit=crop&w=600&q=80' },
    { title: 'Design & Planning', desc: 'Collaborative design and planning services that balance creativity, compliance, and buildability at scale.', tags: ['Architectural Design', 'Technical Drawings', 'Design Coordination', 'Compliance'], img: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80' },
    { title: 'Construction Management', desc: 'Full oversight of construction phases to ensure projects are delivered on time, on budget, and to the highest standards.', tags: ['Site Management', 'Programme Control', 'Quality Assurance', 'Cost Control'], img: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=600&q=80' },
    { title: 'Infrastructure & Logistics', desc: 'Delivery of essential infrastructure and logistics planning to support large residential and urban developments.', tags: ['Roads & Utilities', 'Site Logistics', 'Phasing Strategy', 'Access Planning', 'Utilities Coordination'], img: 'https://images.unsplash.com/photo-1487958449943-2429e8be8625?auto=format&fit=crop&w=600&q=80' },
  ];
  return (
...
function Process() {
  ...
  const steps = [
    { label: 'Step 1', icon: IconBinoculars, phase: 'Phase 01', title: 'Discovery & Brief', body: 'We begin every project with a thorough discovery session — understanding your goals, budget envelope, site constraints, and timeline. This phase defines the entire project foundation and prevents costly changes down the line.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1200&q=80' },
    { label: 'Step 2', icon: IconPencilRuler, phase: 'Phase 02', title: 'Planning & Design', body: 'Our architects and engineers translate the brief into detailed drawings, materials specifications, and a realistic programme. We align design ambition with buildability before a single stone is laid.', img: 'https://images.unsplash.com/photo-1542621334-a254cf47733d?auto=format&fit=crop&w=1200&q=80' },
    { label: 'Step 3', icon: IconBuilding2, phase: 'Phase 03', title: 'Construction & Delivery', body: 'Site teams take over with rigorous programme control, daily quality checks, and transparent weekly reporting. You always know what\'s happening on site — and what\'s coming next.', img: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1200&q=80' },
    { label: 'Step 4', icon: IconHandshake, phase: 'Phase 04', title: 'Handover & Follow-up', body: 'We hand over with a complete snag list resolved, full documentation, and a 12-month aftercare commitment. Our relationship doesn\'t end at completion — it matures into long-term partnership.', img: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1200&q=80' },
  ];
...
function Testimonials() {
  const items = [
    { quote: 'In an industry where delays are common, they delivered ahead of schedule without compromising on quality. That reliability is rare.', name: 'Aisha Verma', role: 'Real Estate Developer', av: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80' },
    { quote: "What stood out was their honesty and commitment. They treated our home like their own and paid attention to every detail.", name: 'Sunil Kapoor', role: 'Residential Client', av: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=200&q=80' },
    { quote: 'We had a clear vision, but they made it even better. The entire process was smooth, transparent, and stress-free from start to finish.', name: 'Rajesh Mehta', role: 'Homeowner', av: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=200&q=80' },
    { quote: 'Their team handled a complex commercial project with complete professionalism. Timelines were met and the quality exceeded expectations.', name: 'Ankit Sharma', role: 'Director, Sharma Enterprises', av: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=200&q=80' },
  ];
...
function Blogs() {
  const items = [
    { cat: 'Site Safety', title: 'Top 10 Construction Site Safety Practices Every Worker Must Know', excerpt: 'Construction sites are high-risk environments — but most accidents are preventable. Here are the essential safety practices every team should follow to stay protected.', img: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1200&q=80' },
    { cat: 'Building Materials', title: 'Concrete vs. Steel vs. Timber: Choosing the Right Building Material', excerpt: 'Choosing the right structural material is one of the most consequential decisions in any construction project. Each material — concrete, steel, and timber — comes with distinct strengths.', img: 'https://images.unsplash.com/photo-1494412519320-aa613dfb7738?auto=format&fit=crop&w=1200&q=80' },
  ];
  return (
