/* FirstStone — About page sections.
   Nav, CtaBanner, Footer, hooks come from shared.jsx. */

const { useState: useStateA } = React;
const { useReveal: useRevealA, useCountUp: useCountUpA, Nav: NavA, CtaBanner: CtaBannerA, Footer: FooterA } = window;
...
{
  name: "Ariana Patel",
  role: "Senior Consultant, Digital",
...
/* -------- STATS strip (bonus, fits the brand) -------- */
function StatLine({ n, suffix, label }) {
  const [ref, val] = useCountUpA(n, 1200);
  return (
