...
(() => {
  ...
  /* -------- cross-page link resolver --------
     On Projects.html / Contact.html / About.html, anchors must point back to the home file. */
  ...
  const isHomePage = !isProjectsPage && !isContactPage && !isAboutPage;
  ...
  function Nav() {
    ...
    const links = [
    { href: "About.html", label: "About", active: isAboutPage },
